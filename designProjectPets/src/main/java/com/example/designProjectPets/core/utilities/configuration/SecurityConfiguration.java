...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	//	http.authorizeRequests()
				  ...
				  //.antMatchers("/api/1.0/auth").hasAnyAuthority("Role_admin", "Role_user")
				  //.antMatchers("/api/1.0/admin/**").hasAuthority("Role_admin")
				  //.antMatchers("/api/1.0/all/**").hasAnyAuthority("Role_admin","Role_user") 
